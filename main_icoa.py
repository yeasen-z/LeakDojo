...
from src import BlackBoxQueryGenerator, WhiteBoxQueryLoader, IKEAQueryGenerator, RtfQueryGenerator
...
def parse_args():
    ...
    # attack
    parser.add_argument("--attack", type=str, choices=["icoa", "bbqg", "wbtq"], default="bbqg", help="Whether to use attack for query generation")
